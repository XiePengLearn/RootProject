...
import com.xiaoanjujia.common.base.baseadapter.BaseMultiItemQuickAdapter;
...
import com.xiaoanjujia.common.widget.autoscrollviewpager.BGABanner;
import com.xiaoanjujia.common.widget.imageview.ExpandImageView;
...
/**
 * @author xp 数据绑定未进行详细的数据验证，再实际使用中不可取
 */
